                            ...
                            <tbody>
                                @forelse($units as $index => $unit)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('master.unit.show', $unit->id) }}" class="btn btn-xs btn-info">
                                                <i class="fa fa-eye"></i>
                                            </a>
                                            <a href="{{ route('master.unit.edit', $unit->id) }}" class="btn btn-xs btn-warning">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <form action="{{ route('master.unit.destroy', $unit->id) }}" method="POST" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-xs btn-danger" onclick="return confirm('Yakin ingin menghapus unit ini?')">
