...
@section('content_header')
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Tambah Layanan <small>Form Tambah Layanan Baru</small></h1>
    <!-- end page-header -->
@endsection
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Form Tambah Layanan</h4>
                <div class="panel-heading-btn">
                    ...
                    <form action="{{ route('master.layanan.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('kode_layanan') is-invalid @enderror" 
                                   id="kode_layanan" name="kode_layanan" value="{{ old('kode_layanan') }}" required>
                            @error('kode_layanan')
