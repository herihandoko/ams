...
@section('title', 'Tambah Storage Media')
...
@section('content_header')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Tambah Storage Media</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Tambah Storage Media <small>Form Tambah Metadata Perangkat Keras Media Penyimpanan</small></h1>
    <!-- end page-header -->
@endsection
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Form Tambah Storage Media</h4>
                <div class="panel-heading-btn">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('master.storage_media.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_data_storage') is-invalid @enderror" 
                               id="nama_data_storage" name="nama_data_storage" value="{{ old('nama_data_storage') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('deskripsi_data_storage') is-invalid @enderror" 
                                  id="deskripsi_data_storage" name="deskripsi_data_storage" rows="3">{{ old('deskripsi_data_storage') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('data_yang_digunakan_id') is-invalid @enderror" id="data_yang_digunakan_id" name="data_yang_digunakan_id">
                            ...
                            @foreach($data['data_metadata'] as $id => $nama)
                                <option value="{{ $id }}" {{ old('data_yang_digunakan_id') == $id ? 'selected' : '' }}>{{ $nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group" id="nama_pemilik_group" style="display: none;">
                        ...
                        <input type="text" class="form-control @error('nama_pemilik') is-invalid @enderror" 
                               id="nama_pemilik" name="nama_pemilik" value="{{ old('nama_pemilik') }}" placeholder="Contoh: Microsoft, Oracle, Telkom">
                        @error('nama_pemilik')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('unit_pengelola_id') is-invalid @enderror" id="unit_pengelola_id" name="unit_pengelola_id">
                            ...
                            @foreach($data['units'] as $id => $nama)
                                <option value="{{ $id }}" {{ old('unit_pengelola_id') == $id ? 'selected' : '' }}>{{ $nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('lokasi_data_storage_id') is-invalid @enderror" id="lokasi_data_storage_id" name="lokasi_data_storage_id">
                            ...
                            @foreach($data['metadata_spbe'] as $id => $nama)
                                <option value="{{ $id }}" {{ old('lokasi_data_storage_id') == $id ? 'selected' : '' }}>{{ $nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('perangkat_lunak_id') is-invalid @enderror" id="perangkat_lunak_id" name="perangkat_lunak_id">
                            ...
                            @foreach($data['software_platforms'] as $id => $nama)
                                <option value="{{ $id }}" {{ old('perangkat_lunak_id') == $id ? 'selected' : '' }}>{{ $nama }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('kapasitas_penyimpanan') is-invalid @enderror" 
                               id="kapasitas_penyimpanan" name="kapasitas_penyimpanan" value="{{ old('kapasitas_penyimpanan') }}" min="1" required>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('metode_akses_data_sharing') is-invalid @enderror" id="metode_akses_data_sharing" name="metode_akses_data_sharing" required>
                            ...
                            <option value="das" {{ old('metode_akses_data_sharing') == 'das' ? 'selected' : '' }}>Direct Attached Storage (DAS)</option>
                            <option value="nas" {{ old('metode_akses_data_sharing') == 'nas' ? 'selected' : '' }}>Network Attached Storage (NAS)</option>
                        </select>
