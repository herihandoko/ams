...
@section('title', 'Tambah Software Platform')
...
@section('content_header')
    ...
    <ol class="breadcrumb pull-right">
        ...
        <li class="active">Tambah Software Platform</li>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header">Tambah Software Platform <small>Form Tambah Metadata Perangkat Lunak Platform</small></h1>
    <!-- end page-header -->
@endsection
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Form Tambah Software Platform</h4>
                <div class="panel-heading-btn">
            ...
            <div class="panel-body">
                ...
                <form action="{{ route('master.software_platform.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_perangkat_lunak') is-invalid @enderror" 
                               id="nama_perangkat_lunak" name="nama_perangkat_lunak" value="{{ old('nama_perangkat_lunak') }}" required>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('deskripsi_perangkat_lunak') is-invalid @enderror" 
                                  id="deskripsi_perangkat_lunak" name="deskripsi_perangkat_lunak" rows="3">{{ old('deskripsi_perangkat_lunak') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('tipe_perangkat_lunak') is-invalid @enderror" id="tipe_perangkat_lunak" name="tipe_perangkat_lunak" required>
                            ...
                            <option value="sistem_operasi" {{ old('tipe_perangkat_lunak') == 'sistem_operasi' ? 'selected' : '' }}>Sistem Operasi</option>
                            <option value="sistem_utilitas" {{ old('tipe_perangkat_lunak') == 'sistem_utilitas' ? 'selected' : '' }}>Sistem Utilitas</option>
                            <option value="sistem_database" {{ old('tipe_perangkat_lunak') == 'sistem_database' ? 'selected' : '' }}>Sistem Database</option>
                        </select>
                    ...
                    <div class="form-group" id="jenis_sistem_operasi_group" style="display: none;">
                        ...
                        <select class="form-control @error('jenis_sistem_operasi') is-invalid @enderror" id="jenis_sistem_operasi" name="jenis_sistem_operasi">
                            ...
                            <option value="dos" {{ old('jenis_sistem_operasi') == 'dos' ? 'selected' : '' }}>DOS</option>
                            <option value="unix" {{ old('jenis_sistem_operasi') == 'unix' ? 'selected' : '' }}>Unix</option>
                            <option value="macos" {{ old('jenis_sistem_operasi') == 'macos' ? 'selected' : '' }}>MacOS</option>
                            <option value="windows" {{ old('jenis_sistem_operasi') == 'windows' ? 'selected' : '' }}>Windows</option>
                            <option value="networking_os" {{ old('jenis_sistem_operasi') == 'networking_os' ? 'selected' : '' }}>Networking OS</option>
                            <option value="lainnya" {{ old('jenis_sistem_operasi') == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                    ...
                    <div class="form-group" id="jenis_sistem_utilitas_group" style="display: none;">
                        ...
                        <input type="text" class="form-control @error('jenis_sistem_utilitas') is-invalid @enderror" 
                               id="jenis_sistem_utilitas" name="jenis_sistem_utilitas" value="{{ old('jenis_sistem_utilitas') }}" placeholder="Contoh: Antivirus, Backup, Monitoring">
                    ...
                    <div class="form-group" id="jenis_sistem_database_group" style="display: none;">
                        ...
                        <input type="text" class="form-control @error('jenis_sistem_database') is-invalid @enderror" 
                               id="jenis_sistem_database" name="jenis_sistem_database" value="{{ old('jenis_sistem_database') }}" placeholder="Contoh: MySQL, PostgreSQL, Oracle">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('jenis_lisensi') is-invalid @enderror" id="jenis_lisensi" name="jenis_lisensi" required>
                            ...
                            <option value="lisensi_seumur_hidup" {{ old('jenis_lisensi') == 'lisensi_seumur_hidup' ? 'selected' : '' }}>Lisensi Seumur Hidup</option>
                            <option value="lisensi_periodik" {{ old('jenis_lisensi') == 'lisensi_periodik' ? 'selected' : '' }}>Lisensi Periodik</option>
                            <option value="kode_sumber_terbuka" {{ old('jenis_lisensi') == 'kode_sumber_terbuka' ? 'selected' : '' }}>Kode Sumber Terbuka</option>
                        </select>
                        @error('jenis_lisensi')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_pemilik_lisensi') is-invalid @enderror" 
                               id="nama_pemilik_lisensi" name="nama_pemilik_lisensi" value="{{ old('nama_pemilik_lisensi') }}" placeholder="Contoh: Microsoft, Oracle, Open Source Community">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control @error('validitas_lisensi') is-invalid @enderror" 
                                  id="validitas_lisensi" name="validitas_lisensi" rows="3">{{ old('validitas_lisensi') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control @error('id_metadata_terkait') is-invalid @enderror" id="id_metadata_terkait" name="id_metadata_terkait">
                            ...
                            @foreach($data['metadata_spbe'] as $id => $nama)
                                <option value="{{ $id }}" {{ old('id_metadata_terkait') == $id ? 'selected' : '' }}>{{ $nama }}</option>
                            @endforeach
                        </select>
