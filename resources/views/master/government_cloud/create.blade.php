...
@section('title', 'Tambah Metadata Komputasi Awan')
    ...
    <div class="col-md-12">
        <div class="panel panel-inverse">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">Tambah Metadata Komputasi Awan</h4>
            </div>
            <div class="panel-body">
                <form action="{{ route('master.government_cloud.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_government_cloud" id="nama_government_cloud" class="form-control @error('nama_government_cloud') is-invalid @enderror" value="{{ old('nama_government_cloud') }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <select name="tipe_government_cloud" id="tipe_government_cloud" class="form-control @error('tipe_government_cloud') is-invalid @enderror" required>
                                    ...
                                    <option value="paas" {{ old('tipe_government_cloud') == 'paas' ? 'selected' : '' }}>PaaS (Platform as a Service)</option>
                                    <option value="iaas" {{ old('tipe_government_cloud') == 'iaas' ? 'selected' : '' }}>IaaS (Infrastructure as a Service)</option>
                                    <option value="saas" {{ old('tipe_government_cloud') == 'saas' ? 'selected' : '' }}>SaaS (Software as a Service)</option>
                                    <option value="bdaas" {{ old('tipe_government_cloud') == 'bdaas' ? 'selected' : '' }}>BDaaS (Big Data as a Service)</option>
                                    <option value="secaas" {{ old('tipe_government_cloud') == 'secaas' ? 'selected' : '' }}>SecaaS (Security as a Service)</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="status_kepemilikan" id="status_kepemilikan" class="form-control @error('status_kepemilikan') is-invalid @enderror" required>
                                    ...
                                    <option value="milik_instansi_pemerintah_lain" {{ old('status_kepemilikan') == 'milik_instansi_pemerintah_lain' ? 'selected' : '' }}>Milik Instansi Pemerintah Lain</option>
                                    <option value="milik_bumn" {{ old('status_kepemilikan') == 'milik_bumn' ? 'selected' : '' }}>Milik BUMN</option>
                                    <option value="milik_pihak_ketiga" {{ old('status_kepemilikan') == 'milik_pihak_ketiga' ? 'selected' : '' }}>Milik Pihak Ketiga</option>
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nama_pemilik" id="nama_pemilik" class="form-control @error('nama_pemilik') is-invalid @enderror" value="{{ old('nama_pemilik') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="biaya_layanan" id="biaya_layanan" class="form-control @error('biaya_layanan') is-invalid @enderror" value="{{ old('biaya_layanan') }}" step="0.01" min="0">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="unit_pengembang_id" id="unit_pengembang_id" class="form-control @error('unit_pengembang_id') is-invalid @enderror">
                                    ...
                                    @foreach($data['units'] as $id => $nama)
                                        <option value="{{ $id }}" {{ old('unit_pengembang_id') == $id ? 'selected' : '' }}>{{ $nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select name="unit_operasional_id" id="unit_operasional_id" class="form-control @error('unit_operasional_id') is-invalid @enderror">
                                    ...
                                    @foreach($data['units'] as $id => $nama)
                                        <option value="{{ $id }}" {{ old('unit_operasional_id') == $id ? 'selected' : '' }}>{{ $nama }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jangka_waktu_pelayanan" id="jangka_waktu_pelayanan" class="form-control @error('jangka_waktu_pelayanan') is-invalid @enderror" value="{{ old('jangka_waktu_pelayanan') }}" placeholder="Contoh: 1 tahun, 6 bulan">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_government_cloud" id="deskripsi_government_cloud" class="form-control @error('deskripsi_government_cloud') is-invalid @enderror" rows="4">{{ old('deskripsi_government_cloud') }}</textarea>
